...
import RecentMultipliers from "../components/RecentMultipliers";
        ...
        <div className="px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-sm">
              <span className="text-gray-400">For Assistance, Whatsapp:</span>
              <a href="https://wa.me/254746111111" className="text-green-500 font-semibold flex items-center gap-1">
              ...
              {isAuthenticated && user ? (
                <>
                  <div className="text-right">
                    ...
                    <p className="text-white font-semibold">{balance?.toFixed(2) || "0.00"} KSH</p>
                  </div>
                  <button
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-2 px-6 rounded-lg transition-colors"
                  >
                    Register
                  </button>
                </div>

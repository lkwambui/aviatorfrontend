        ...
        <div className="px-4 sm:px-6 py-3">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2 text-xs sm:text-sm">
              <span className="hidden sm:inline text-gray-400">For Assistance, Whatsapp:</span>
              ...
              {isAuthenticated && user ? (
                <>
                  ...
                  <button
                    ...
                    className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-3 sm:px-4 rounded-lg transition-colors text-sm sm:text-base"
                  >
                    Logout
                  </button>
                </>
